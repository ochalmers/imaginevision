          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-wire">
                <th className="py-3 text-left font-medium text-ink">Endpoint</th>
                <th className="py-3 text-left font-medium text-ink">Description</th>
              </tr>
            </thead>
            <tbody className="text-ash">
              <tr className="border-b border-wire/50"><td className="py-2 font-mono">POST /v1/render</td><td>Submit configuration, receive rendered image</td></tr>
              <tr className="border-b border-wire/50"><td className="py-2 font-mono">POST /v1/configure/validate</td><td>Validate configuration against product rules</td></tr>
              <tr className="border-b border-wire/50"><td className="py-2 font-mono">GET /v1/products/:id</td><td>Retrieve full product definition</td></tr>
            </tbody>
          </table>
        </div>
      </Section>
